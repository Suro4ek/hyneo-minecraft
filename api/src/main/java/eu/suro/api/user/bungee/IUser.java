...
import eu.suro.api.user.APIBungee;
...
public interface IUser {
    static Stream<IUser> getUsers() {
        return APIBungee.getUserManager().getUsers();
    }
    ...
    static IUser getUser(ProxiedPlayer player) {
        return APIBungee.getUserManager().getUser(player);
    }
