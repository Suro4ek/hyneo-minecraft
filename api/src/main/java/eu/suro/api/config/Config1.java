...
public class Config1 {
    ...
    public void createSectionIfNotExist(String path) {
        if (!contains(path)) {
            setAndSave(path + ".lkjsdafknhsdjklhfalsjhfwui3324ij2i3j4", 10);
            setAndSave(path + ".lkjsdafknhsdjklhfalsjhfwui3324ij2i3j4", (Object)null);
        }
    }
    ...
    public Integer getInt(String path,int def) {
        return this.getNumber(path)instanceof Number ? this.getNumber(path).intValue() : def;
    }
